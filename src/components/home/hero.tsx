...
export default function HeroSection () {
    return (
        ...
        //                 <br />
        //                 <span className="text-gray-900"> advertisers, publishers</span>
        //                 <br />
        //                 <span className="text-gray-900"> and agencies</span>
        //                 </h2>
        ...
        //                     <img src="/dashboard.png" alt="Dashboard" className="object-cover object-center w-full h-full" />
        //                 </div>
        //                 <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-16 z-10 w-full max-w-md">
        ...
        //                                 </svg>
        //                             </div>
        //                             <span className="text-gray-900 font-medium text-xl">High quality traffic</span>
        //                         </div>
        //                         <div className="flex items-center bg-opacity-90 p-4">
        //                             <div className="mr-3 p-2 bg-blue-50 rounded-full w-11 h-11 flex justify-center items-center">
        //                                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#1E88E5" className="w-7 h-7">
        ...
        //                                 </svg>
        //                             </div>
        //                             <span className="text-gray-900 font-medium text-xl">Advanced API tools</span>
        //                         </div>
        //                         <div className="flex items-center bg-opacity-90 p-4">
        //                             <div className="mr-3 p-2 bg-blue-50 rounded-full w-11 h-11 flex justify-center items-center">
        //                                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#1E88E5" className="w-7 h-7">
        ...
        //                                 </svg>
        //                             </div>
        //                             <span className="text-gray-900 font-medium text-xl">Worldwide coverage</span>
        //                         </div>
        //                     </div>
        //                 </div>
        //             </div>
