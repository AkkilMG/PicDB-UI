...
const Header = () => {
    return (
        ...
        <div className="container mx-auto flex justify-between items-center py-3">
          <div className="ml-8">
            <img src='assets/images/letter.png' alt='PicDB logo' width={100} height={40} />
          </div>
          <div className="mr-8 flex items-center space-x-4">
            <button onClick={() => window.location.href = "/upload"} className="border-2 rounded-md py-1 px-4">Get started</button>
