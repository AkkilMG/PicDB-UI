          ...
          {step === "email" ? (
            <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Akkil M G" />
                </div>
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <Input id="email-signup" type="email" placeholder="Email Address" value={email} className="pl-10 pr-10"
                    onChange={(e) => {
              ...
              <Button type="button" className="w-full bg-blue-600 hover:bg-blue-700 text-white" onClick={(e: any) => handleEmailVerification(1)} disabled={isVerifying}>
                {isVerifying ? (
                  <>
