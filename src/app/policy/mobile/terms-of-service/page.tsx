            ...
            <div className="font-sans antialiased bg-white text-gray-900">
                <div className="max-w-4xl mx-auto px-4 py-10 sm:py-20">
                    ...
                    <p className="text-gray-700 text-center mb-12">
                        By using the PikDB mobile app, you agree to the following terms and conditions.
                    </p>
                    ...
                    <PolicyBody no={1} title="Acceptance of Terms" body={[
                        "By downloading, accessing, or using the PikDB mobile application ('App'), you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree, please do not use our App."
                    ]} />
