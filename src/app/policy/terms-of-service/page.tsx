            ...
            <div className="font-sans antialiased bg-white text-gray-900">
                <div className="max-w-4xl mx-auto px-4 py-10 sm:py-20">
                    ...
                    <h1 className="text-4xl lg:text-5xl font-bold text-center text-gray-800 mb-6">
                        Terms of Service for PikDB
                    </h1>

                    {/* Subtitle */}
                    <p className="text-gray-700 text-center mb-12">
                        By using PikDB, you agree to the following terms and conditions.
                    </p>
                    ...
                    <PolicyBody no={1} title="Acceptance of Terms" body={[
                        "By accessing or using PikDB, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree, please do not use our Services."
                    ]} />

                    {/* Section */}
                    <PolicyBody no={2} title="Use of Services" body={[
                        "PikDB provides a storage platform for images, offering encryption, sharing, and security features. By using our Services, you agree to:"
                    ]} points={[
                        "Use PikDB only for lawful purposes.",
                    ...
                    <PolicyBody no={3} title="User Accounts & Security" body={[
                        ...
                        "Report any unauthorized access immediately to PikDB support."
                    ]} />

                    {/* Section */}
                    <PolicyBody no={4} title="Uploaded Content & Rights" body={[
                        "By uploading content to PikDB, you retain all ownership rights to your images. PikDB only owns the software platform itself and does not claim any ownership over user-uploaded content."
                    ]} points={[
                        "PikDB does not own, claim ownership, or have any proprietary rights to your uploaded content.",
                    ...
                    <PolicyBody no={5} title="Prohibited Activities" body={[
                        "You agree not to engage in any of the following activities while using PikDB:"
                    ]} points={[
                        "Uploading or sharing illegal, harmful, or offensive content.",
                        "Attempting to hack, exploit, or disrupt the platform.",
                        "Using PikDB for fraudulent, malicious, or unethical purposes.",
                        "Violating any applicable data protection laws."
                    ]} />

                    {/* Section */}
                    <PolicyBody no={6} title="Data Storage & Retention" body={[
                        "PikDB provides storage for images with encryption and security measures. However:"
                    ]} points={[
                    ...
                    <PolicyBody no={7} title="Service Availability & Modifications" body={[
                        "We strive to maintain high availability but do not guarantee uninterrupted access to PikDB. We may modify, suspend, or discontinue Services at any time."
                    ]} />

                    {/* Section */}
                    <PolicyBody no={8} title="Content Responsibility & Platform Disclaimer" body={[
                        "PikDB is a software platform only. We do not own, review, or control user-uploaded content:"
                    ]} points={[
                        "All uploaded content remains the sole property and responsibility of the uploader.",
                        "PikDB acts only as a neutral technology platform providing storage and sharing services.",
                        ...
                        "Legal disputes regarding content should be addressed with the content owner, not PikDB.",
                    ...
                    <PolicyBody no={9} title="Limitation of Liability & Content Disclaimer" body={[
                        "PikDB and its owners, employees, and partners shall not be held liable for:"
                    ]} points={[
                        ...
                        "Any legal actions should be directed towards the content owner, not PikDB platform.",
                    ...
                    <PolicyBody no={10} title="Termination of Use" body={[
                        "We reserve the right to suspend or terminate your access to PikDB if you violate these terms."
                    ]} />

                    {/* Section */}
                    <PolicyBody no={11} title="Changes to Terms" body={[
                        "We may update these Terms of Service from time to time. Continued use of PikDB after updates constitutes acceptance of the revised terms."
                    ]} />
